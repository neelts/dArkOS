...
# PICO-8 kiosk build: all non-PICO-8 emulators stripped.
# See plan: only fake08 (fallback), ogage/ogacontrols, gptokeyb, drmtool,
# emulationstation (service is hijacked), finishing_touches remain.
